...
FALLBACK_PROMPT = (
    ...
    "Без крупных надписей; только внизу небольшая плашка в стиле картинки: сначала дата "
    "по-русски числом и месяцем, затем через разделитель — какие сегодня праздники. "
    "Спрячь в кадре небольшой весёлый визуальный сюрприз — деталь, которую зрителю "
