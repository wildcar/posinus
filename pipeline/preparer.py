...
RETELL_SYSTEM = (
    ...
    "- Заголовок пересказывает новость сам: кто и что сделал, понятно без открытия "
    "текста. Без загадок и кликбейта. Плохо: «Незнакомка с подносом». Хорошо: "
    "«Путешественник застрял в деревне — незнакомая женщина принесла ему еду». "
    "Тело от двух до четырёх абзацев.\n"
